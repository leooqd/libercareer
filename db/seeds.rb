...
Person.all.each(&:set_preferred_phone)
...
License.create(person_id: 1, number: 7_195_601_426, modalities_ids: [1, 2], expiration: '02/12/2023')
License.create(person_id: 2, number: 6_943_716_123, modalities_ids: [1, 3], expiration: '02/12/2022')
License.create(person_id: 3, number: 1_180_791_711, modalities_ids: [2], expiration: '02/12/2024')
License.create(person_id: 4, number: 4_022_223_573, modalities_ids: [5], expiration: '02/12/2023')
License.create(person_id: 5, number: 4_792_176_902, modalities_ids: [4], expiration: '02/12/2023')
License.create(person_id: 6, number: 1_910_131_222, modalities_ids: [1, 2], expiration: '02/12/2023')
License.create(person_id: 7, number: 6_892_136_432, modalities_ids: [1], expiration: '02/12/2019')
